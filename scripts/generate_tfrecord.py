    ...
    for xml_file in glob.glob(path + "/*.xml"):
        ...
        for member in root.findall("object"):
            value = (
                ...
                member[0].text,
                int(member.find("object").find("bndbox").find("xmin").text),
                int(member.find("object").find("bndbox").find("ymin").text),
                int(member.find("object").find("bndbox").find("xmax").text),
                int(member.find("object").find("bndbox").find("ymax").text),
            )
